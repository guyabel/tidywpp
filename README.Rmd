...
Data downloaded using tidywpp is in [tidy](https://vita.had.co.nz/papers/tidy-data.pdf) form, and hence requires none or minimal manipulations for use in common modelling or visualisation functions in R.

```{r}
d <- get_wpp(indicator = c("PopMale", "PopFemale"), 
