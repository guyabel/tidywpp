...
# PopTotal, PopMale and PopFemale indicators are in many WPP files with a wide range granularity. Set indicator = "pop" and use the pop_sex, pop_age, pop_freq and pop_date to get desired data from the appropriate indicator_file...
